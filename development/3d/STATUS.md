...
- M4: source-supported plane sections, ordinary visibility and attribute-driven section styling are implemented; see SECTIONS.md. Planar hatch/crosshatch and remaining composition requirements are pending.
