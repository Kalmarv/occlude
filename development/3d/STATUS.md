...
- M2: polygon topology, feature extraction, projected BVH, streamed mesh visibility and lab feature filtering implemented; see MESH.md. Hardware source and served-bundle verification pass; full pnpm check passes with unchanged 2D ink and WASM hash. Generic chaining, protected stroke integration and remaining milestone requirements are still pending.
