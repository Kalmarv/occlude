...
- M3: editable grid, face selection/measures, independent extrusion with parentage, transforms, frozen passes and hardware GPU displacement/adjacency are implemented; see MODEL.md. Surface queries and remaining workflow requirements are pending.
