...
- M5: saved results now retain committed camera/realized geometry/backend provenance; see CAPTURE.md. The changed-library source and served-bundle browser round trips pass. Hardening and handoff remain unfinished. No large-scene performance or full MVP completion claim.
