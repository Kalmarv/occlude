...
export default sketch({ ...({ seed: 42, pens: {
  ink: pen({ width: mm(0.3), color: '#18202A' }),
    ...
    "@1": {"eye":[6.154114026941713,8.205485369255618,5.128428355784761],"target":[0,0,0],"kind":"perspective","near":0.3871745337732534,"far":100.28717453377325,"up":[0,0,1],"fovDegrees":45}
  } }, () => {
  console.info('mesh-model'); const block = box([1.6, 1.6, 2]);
