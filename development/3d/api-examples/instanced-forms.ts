// Acceptance target: shared prototypes until an explicit realize operation.
...
export default sketch({seed:42,pens:{ink:pen({width:mm(.25),color:'#18202A'})}},t=>{
  ...
  return view(forms,{camera:perspective({eye:[8,10,8],target:[0,0,.5],fovDegrees:40}),stroke:'ink'});
});
