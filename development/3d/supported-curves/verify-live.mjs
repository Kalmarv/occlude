...
try{
 ...
 await page.goto(base);await page.waitForFunction(()=>document.querySelector('#status-build')?.textContent.includes('e9e4e60-supported-curves'));console.log(await page.locator('#status-build').textContent());
