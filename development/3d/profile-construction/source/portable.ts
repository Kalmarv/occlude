...
export default sketch({ ...({ seed: 42, pens: {
  ...
  shade: pen({ width: mm(0.18), color: '#A84932' }),
    ...
    "@1": {"eye":[7,10,7],"target":[0,0,0],"kind":"perspective","near":0.1,"far":100,"up":[0,0,1],"fovDegrees":37.306052287899426}
  } }, () => {
  console.info('mesh-model'); const vessel = revolve(polyline([
