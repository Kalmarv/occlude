...
writeFileSync(root+'development/3d/benchmark-surface/cpu.json',JSON.stringify({hardware:'headless node, CPU reference, no GPU',node:process.version,rows},null,2)+'\n');
