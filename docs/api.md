...
ease.cubicIn(t) …    // the easings.net catalog: quad/cubic/quart/quint/sin/expo/circ/
                     // back/elastic/bounce × In|Out|InOut, smooth/smoother (smoothstep),
                     // powIn(t, p). All pin (0,0)→(1,1); back/elastic overshoot between.
