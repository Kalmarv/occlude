 ...
 *     node tools/ink-digest-three.mjs   (from packages/occlude-studio, where playwright is installed)
 *
...
const out = process.env.OCCLUDE_INK_OUT ?? '../occlude/bench/three/results/ink-digest.json';
