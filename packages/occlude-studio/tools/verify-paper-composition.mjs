...
const output = resolve('../../development/3d/playwright-paper-composition');
...
try {
  ...
  await writeFile(resolve(output, 'report.json'), JSON.stringify({ passed: true, initial, committed, reopened, errors }, null, 2));
