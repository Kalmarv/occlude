...
const output = resolve(process.env.OCCLUDE_GPU_EVIDENCE ?? '../../development/3d/playwright-selection');
...
try {
  ...
  assert(/a84932/i.test(svg), 'marked edge pen must survive Studio SVG export');
