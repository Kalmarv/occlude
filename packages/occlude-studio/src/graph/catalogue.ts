...
export const CATALOGUE: Catalogue = {
  ...
  importable: [
    { module: 'occlude', names: [
      ...
      { name: 'editEdges3', spec: 'editEdges3' }, { name: 'editPoints3', spec: 'editPoints3' }, { name: 'ellipse', spec: 'ellipse' }, { name: 'encodePlanBuffer', spec: 'encodePlanBuffer' },
      { name: 'encodeScene', spec: 'encodeScene' }, { name: 'encodeToolpath', spec: 'encodeToolpath' }, { name: 'envelope', spec: 'envelope' }, { name: 'estimatePlanMs', spec: 'estimatePlanMs' },
      { name: 'evalPrim', spec: 'evalPrim' }, { name: 'exportCollisions', spec: 'exportCollisions' }, { name: 'exportGcode', spec: 'exportGcode' }, { name: 'exportPng', spec: 'exportPng' },
      { name: 'exportSvg', spec: 'exportSvg' }, { name: 'extent', spec: 'extent' }, { name: 'extrudeFaces3', spec: 'extrudeFaces3' }, { name: 'faces', spec: 'faces' },
      { name: 'FeatureKind3', spec: 'FeatureKind3' }, { name: 'fill', spec: 'fill' }, { name: 'FILL_NAME_RE', spec: 'FILL_NAME_RE' }, { name: 'fillAsset', spec: 'fillAsset' },
      { name: 'fillTable', spec: 'fillTable' }, { name: 'fitDuration', spec: 'fitDuration' }, { name: 'force', spec: 'force' }, { name: 'formatSeed', spec: 'formatSeed' },
      { name: 'fromAngle', spec: 'fromAngle' }, { name: 'grad', spec: 'grad' }, { name: 'grid3', spec: 'grid3' }, { name: 'group', spec: 'group' },
      { name: 'h', spec: 'h' }, { name: 'hashPlan', spec: 'hashPlan' }, { name: 'hatch3', spec: 'hatch3' }, { name: 'inch', spec: 'inch' },
      { name: 'inheritEdge', spec: 'inheritEdge' }, { name: 'initOcclude', spec: 'initOcclude' }, { name: 'inspectHook', spec: 'inspectHook' }, { name: 'interlace', spec: 'interlace' },
      { name: 'invert', spec: 'invert' }, { name: 'invertRange', spec: 'invertRange' }, { name: 'isBuiltinFill', spec: 'isBuiltinFill' }, { name: 'isLineArt3', spec: 'isLineArt3' },
      { name: 'isSketch', spec: 'isSketch' }, { name: 'isSketchAsync', spec: 'isSketchAsync' }, { name: 'isStations', spec: 'isStations' }, { name: 'label', spec: 'label' },
      { name: 'labelWidth', spec: 'labelWidth' }, { name: 'length', spec: 'length' }, { name: 'liftAt', spec: 'liftAt' }, { name: 'liftForTravel', spec: 'liftForTravel' },
      ...
      { name: 'map', spec: 'map' }, { name: 'mask', spec: 'mask' }, { name: 'material', spec: 'material' }, { name: 'meanBy', spec: 'meanBy' },
      { name: 'measureFaces3', spec: 'measureFaces3' }, { name: 'mm', spec: 'mm' }, { name: 'modify', spec: 'modify' }, { name: 'moduleName', spec: 'moduleName' },
      { name: 'mul', spec: 'mul' }, { name: 'neighbours', spec: 'neighbours' }, { name: 'ngon', spec: 'ngon' }, { name: 'norm', spec: 'norm' },
      { name: 'numericLoops', spec: 'numericLoops' }, { name: 'openPlan', spec: 'openPlan' }, { name: 'oscillate', spec: 'oscillate' }, { name: 'ownedBy', spec: 'ownedBy' },
      ...
      { name: 'path', spec: 'path' }, { name: 'pen', spec: 'pen' }, { name: 'penModel', spec: 'penModel' }, { name: 'pensToJson', spec: 'pensToJson' },
      ...
      { name: 'planToolpath', spec: 'planToolpath' }, { name: 'planValue', spec: 'planValue' }, { name: 'pointCloud3', spec: 'pointCloud3' }, { name: 'polygon', spec: 'polygon' },
      ...
      { name: 'sketch', spec: 'sketch' }, { name: 'sketchAsync', spec: 'sketchAsync' }, { name: 'smooth', spec: 'smooth' }, { name: 'snap', spec: 'snap' },
      { name: 'snapshotSurface3', spec: 'snapshotSurface3' }, { name: 'standaloneEstimate', spec: 'standaloneEstimate' }, { name: 'stationsMaterial', spec: 'stationsMaterial' }, { name: 'stepsSurface3', spec: 'stepsSurface3' },
      { name: 'stroke', spec: 'stroke' }, { name: 'strokes', spec: 'strokes' }, { name: 'sub', spec: 'sub' }, { name: 'subPrim', spec: 'subPrim' },
      { name: 'sum', spec: 'sum' }, { name: 'sumBy', spec: 'sumBy' }, { name: 'sumForces', spec: 'sumForces' }, { name: 'surface3', spec: 'surface3' },
      { name: 'svg', spec: 'svg' }, { name: 'synth', spec: 'synth' }, { name: 'tagDraws', spec: 'tagDraws' }, { name: 'thicken', spec: 'thicken' },
      ...
      { name: 'w', spec: 'w' }, { name: 'warp', spec: 'warp' }, { name: 'within', spec: 'within' }, { name: 'wobble', spec: 'wobble' },
    ] },
    { module: 'occlude/3d', names: [
      { name: 'across', spec: 'across' }, { name: 'alignAxis', spec: 'alignAxis' }, { name: 'axisAngle', spec: 'axisAngle' }, { name: 'box', spec: 'box' },
      { name: 'circle3', spec: 'circle as circle3' }, { name: 'cone', spec: 'cone' }, { name: 'curvature', spec: 'curvature' }, { name: 'curve3', spec: 'curve as curve3' },
      { name: 'cylinder', spec: 'cylinder' }, { name: 'cylindricalUV', spec: 'cylindricalUV' }, { name: 'falloff', spec: 'falloff' }, { name: 'force3', spec: 'force as force3' },
      { name: 'gradient', spec: 'gradient' }, { name: 'grid', spec: 'grid' }, { name: 'instanceOnFaces', spec: 'instanceOnFaces' }, { name: 'instanceOnPoints', spec: 'instanceOnPoints' },
      { name: 'intersections', spec: 'intersections' }, { name: 'isolines', spec: 'isolines' }, { name: 'laneThreshold', spec: 'laneThreshold' }, { name: 'light', spec: 'light' },
      { name: 'mapSurface', spec: 'mapSurface' }, { name: 'mesh', spec: 'mesh' }, { name: 'orthographic', spec: 'orthographic' }, { name: 'perspective', spec: 'perspective' },
      { name: 'planarUV', spec: 'planarUV' }, { name: 'plane', spec: 'plane' }, { name: 'pointCloud', spec: 'pointCloud' }, { name: 'polyline', spec: 'polyline' },
      { name: 'query3', spec: 'query as query3' }, { name: 'revolve', spec: 'revolve' }, { name: 'sphere', spec: 'sphere' }, { name: 'style', spec: 'style' },
