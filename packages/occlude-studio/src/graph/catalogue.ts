...
export const CATALOGUE: Catalogue = {
  ...
  importable: [
    { module: 'occlude', names: [
      ...
      { name: 'DOC_PAGES', spec: 'DOC_PAGES' }, { name: 'docsPaper', spec: 'docsPaper' }, { name: 'dot', spec: 'dot' }, { name: 'DRAW_HOOK', spec: 'DRAW_HOOK' },
      { name: 'drawFragments', spec: 'drawFragments' }, { name: 'drawing3', spec: 'drawing3' }, { name: 'ease', spec: 'ease' }, { name: 'EdgeSelection', spec: 'EdgeSelection' },
      { name: 'EdgeSelection3', spec: 'EdgeSelection3' }, { name: 'editEdges3', spec: 'editEdges3' }, { name: 'editPoints3', spec: 'editPoints3' }, { name: 'ellipse', spec: 'ellipse' },
      { name: 'encodePlanBuffer', spec: 'encodePlanBuffer' }, { name: 'encodeScene', spec: 'encodeScene' }, { name: 'encodeToolpath', spec: 'encodeToolpath' }, { name: 'estimatePlanMs', spec: 'estimatePlanMs' },
      { name: 'evalPrim', spec: 'evalPrim' }, { name: 'Execution', spec: 'Execution' }, { name: 'exportCollisions', spec: 'exportCollisions' }, { name: 'exportGcode', spec: 'exportGcode' },
      { name: 'exportPng', spec: 'exportPng' }, { name: 'exportSvg', spec: 'exportSvg' }, { name: 'extent', spec: 'extent' }, { name: 'extrudeFaces3', spec: 'extrudeFaces3' },
      { name: 'FaceMeasurements', spec: 'FaceMeasurements' }, { name: 'faces', spec: 'faces' }, { name: 'Faces', spec: 'Faces' }, { name: 'FaceSelection', spec: 'FaceSelection' },
      { name: 'FaceSelection3', spec: 'FaceSelection3' }, { name: 'FeatureKind3', spec: 'FeatureKind3' }, { name: 'FeatureSelection3', spec: 'FeatureSelection3' }, { name: 'fill', spec: 'fill' },
      { name: 'FILL_NAME_RE', spec: 'FILL_NAME_RE' }, { name: 'fillAsset', spec: 'fillAsset' }, { name: 'fillTable', spec: 'fillTable' }, { name: 'fitDuration', spec: 'fitDuration' },
      { name: 'force', spec: 'force' }, { name: 'formatSeed', spec: 'formatSeed' }, { name: 'fromAngle', spec: 'fromAngle' }, { name: 'GpuSceneCompute3', spec: 'GpuSceneCompute3' },
      { name: 'grad', spec: 'grad' }, { name: 'grid3', spec: 'grid3' }, { name: 'group', spec: 'group' }, { name: 'h', spec: 'h' },
      { name: 'hashPlan', spec: 'hashPlan' }, { name: 'hatch3', spec: 'hatch3' }, { name: 'inch', spec: 'inch' }, { name: 'inheritEdge', spec: 'inheritEdge' },
      { name: 'initOcclude', spec: 'initOcclude' }, { name: 'inspectHook', spec: 'inspectHook' }, { name: 'invert', spec: 'invert' }, { name: 'invertRange', spec: 'invertRange' },
      { name: 'isBuiltinFill', spec: 'isBuiltinFill' }, { name: 'isGeometry', spec: 'isGeometry' }, { name: 'isLineArt3', spec: 'isLineArt3' }, { name: 'isSketch', spec: 'isSketch' },
      { name: 'isSketchAsync', spec: 'isSketchAsync' }, { name: 'isStations', spec: 'isStations' }, { name: 'label', spec: 'label' }, { name: 'labelWidth', spec: 'labelWidth' },
      { name: 'Len', spec: 'Len' }, { name: 'length', spec: 'length' }, { name: 'liftAt', spec: 'liftAt' }, { name: 'liftForTravel', spec: 'liftForTravel' },
      { name: 'liftMapFromCounts', spec: 'liftMapFromCounts' }, { name: 'limit', spec: 'limit' }, { name: 'line', spec: 'line' }, { name: 'lineArt3', spec: 'lineArt3' },
      { name: 'liveExampleToJs', spec: 'liveExampleToJs' }, { name: 'loadFillModule', spec: 'loadFillModule' }, { name: 'long', spec: 'long' }, { name: 'makePlan', spec: 'makePlan' },
      { name: 'map', spec: 'map' }, { name: 'mask', spec: 'mask' }, { name: 'material', spec: 'material' }, { name: 'Material', spec: 'Material' },
      { name: 'meanBy', spec: 'meanBy' }, { name: 'measureFaces3', spec: 'measureFaces3' }, { name: 'mm', spec: 'mm' }, { name: 'modify', spec: 'modify' },
      { name: 'moduleName', spec: 'moduleName' }, { name: 'mul', spec: 'mul' }, { name: 'ngon', spec: 'ngon' }, { name: 'norm', spec: 'norm' },
      { name: 'numericLoops', spec: 'numericLoops' }, { name: 'openPlan', spec: 'openPlan' }, { name: 'ownedBy', spec: 'ownedBy' }, { name: 'paper', spec: 'paper' },
      ...
      { name: 'smooth', spec: 'smooth' }, { name: 'snapshotSurface3', spec: 'snapshotSurface3' }, { name: 'standaloneEstimate', spec: 'standaloneEstimate' }, { name: 'stationsMaterial', spec: 'stationsMaterial' },
      { name: 'stepsSurface3', spec: 'stepsSurface3' }, { name: 'stroke', spec: 'stroke' }, { name: 'strokes', spec: 'strokes' }, { name: 'sub', spec: 'sub' },
      { name: 'subPrim', spec: 'subPrim' }, { name: 'sum', spec: 'sum' }, { name: 'sumBy', spec: 'sumBy' }, { name: 'sumForces', spec: 'sumForces' },
      { name: 'surface3', spec: 'surface3' }, { name: 'svg', spec: 'svg' }, { name: 'synth', spec: 'synth' }, { name: 'tagDraws', spec: 'tagDraws' },
      { name: 'times', spec: 'times' }, { name: 'tourBudget', spec: 'tourBudget' }, { name: 'tracePrim', spec: 'tracePrim' }, { name: 'transformSurface3', spec: 'transformSurface3' },
      { name: 'translate', spec: 'translate' }, { name: 'travelLiftPulse', spec: 'travelLiftPulse' }, { name: 'ui', spec: 'ui' }, { name: 'unit', spec: 'unit' },
      { name: 'userModules', spec: 'userModules' }, { name: 'userUnitsToPaper', spec: 'userUnitsToPaper' }, { name: 'vectorField', spec: 'vectorField' }, { name: 'voronoi', spec: 'voronoi' },
      { name: 'w', spec: 'w' }, { name: 'within', spec: 'within' }, { name: 'wobble', spec: 'wobble' },
    ] },
