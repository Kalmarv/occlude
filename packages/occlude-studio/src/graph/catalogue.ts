...
export const CATALOGUE: Catalogue = {
  words: [
    ...
    },
    {
      ...
      params: [
        ...
        { name: 'opts', optional: true, options: [
          ...
          { name: 'fillPen', takes: { socket: 'Pen' }, optional: true },
    ...
    {
      word: 'deform', module: 'occlude', receiver: null,
      import: 'deform', call: 'deform', returns: 'shape',
      page: '/docs/reference/shapes', group: 'Shapes',
      params: [
    ...
    {
      word: 'dots', module: 'occlude', receiver: null,
      import: 'dots', call: 'dots', returns: 'shape',
      page: '/docs/reference/shapes', group: 'Shapes',
      params: [
        { name: 'points', takes: { socket: 'Geometry' }, optional: false },
        { name: 'opts', optional: true, options: [
          { name: 'pen', takes: { socket: 'Pen' }, optional: true },
        ] },
      ],
    ...
    {
      word: 'curl', module: 'occlude', receiver: null,
      import: 'curl', call: 'curl', returns: 'VectorField',
      page: '/docs/reference/fields', group: 'Fields',
      params: [
        { name: 'field', takes: { socket: 'Field' }, optional: false },
        { name: 'h', takes: { socket: 'Number' }, optional: true },
      ],
    },
    {
      ...
      page: '/docs/reference/fields', group: 'Fields',
      params: [
        { name: 'boundary', takes: { socket: 'Geometry' }, optional: false },
      ],
    },
    {
      word: 'grad', module: 'occlude', receiver: null,
      import: 'grad', call: 'grad', returns: 'VectorField',
      page: '/docs/reference/fields', group: 'Fields',
      params: [
        { name: 'field', takes: { socket: 'Field' }, optional: false },
        { name: 'h', takes: { socket: 'Number' }, optional: true },
    ...
    {
      word: 't.streamlines', module: 'occlude', receiver: 't',
      import: null, call: 't.streamlines', returns: 'material',
      page: '/docs/reference/fields', group: 'Fields',
      params: [
        { name: 'field', takes: { socket: 'VectorField' }, optional: false },
        { name: 'opts', optional: true, options: [
          { name: 'spacing', takes: { socket: 'Field' }, optional: true },
          { name: 'minSpacing', takes: { socket: 'Number' }, optional: true },
          { name: 'step', takes: { socket: 'Number' }, optional: true },
    ...
    {
      word: 'vectorField', module: 'occlude', receiver: null,
      import: 'vectorField', call: 'vectorField', returns: 'VectorField',
      page: '/docs/reference/fields', group: 'Fields',
      params: [
        { name: 'fn', takes: { socket: 'VectorField' }, optional: false },
      ],
    },
    {
    ...
    {
      word: 'Material.snap', module: 'occlude', receiver: null,
      import: null, call: '{self}.snap', returns: 'material',
      self: { param: 'material', takes: { socket: 'Geometry', kinds: ['material'] } },
    ...
    {
      word: 'Material.trails', module: 'occlude', receiver: null,
      import: null, call: '{self}.trails', returns: 'material',
      self: { param: 'material', takes: { socket: 'Geometry', kinds: ['material'] } },
      page: '/docs/reference/connect', group: 'Connect',
      params: [
      ],
    ...
    {
      word: 'PointSelection.adjacent', module: 'occlude', receiver: null,
      import: null, call: '{self}.adjacent', returns: 'points',
    ...
    {
      word: 'PointSelection.components', module: 'occlude', receiver: null,
      import: null, call: '{self}.components', returns: 'points',
      self: { param: 'points', takes: { socket: 'Geometry', kinds: ['points'] } },
      page: '/docs/reference/selections', group: 'Selections',
      params: [
      ],
    ...
    {
      word: 'PointSelection.connected', module: 'occlude', receiver: null,
      import: null, call: '{self}.connected', returns: 'points',
      self: { param: 'points', takes: { socket: 'Geometry', kinds: ['points'] } },
      page: '/docs/reference/selections', group: 'Selections',
      params: [
      ],
    ...
    {
      word: 'PointSelection.edges', module: 'occlude', receiver: null, value: true,
      import: null, call: '{self}.edges', returns: 'material',
      self: { param: 'points', takes: { socket: 'Geometry', kinds: ['points'] } },
      page: '/docs/reference/selections', group: 'Selections',
      params: [
    ...
    {
      word: 'Faces.edges', module: 'occlude', receiver: null, value: true,
      import: null, call: '{self}.edges', returns: 'material',
      self: { param: 'faces', takes: { socket: 'Geometry', kinds: ['faces'] } },
      page: '/docs/reference/faces', group: 'Faces',
      params: [
    ...
    {
      word: 'Faces.points', module: 'occlude', receiver: null, value: true,
      import: null, call: '{self}.points', returns: 'points',
      self: { param: 'faces', takes: { socket: 'Geometry', kinds: ['faces'] } },
      page: '/docs/reference/faces', group: 'Faces',
      params: [
    ...
    {
      word: 'Material.envelope', module: 'occlude', receiver: null,
      import: null, call: '{self}.envelope', returns: 'material',
      self: { param: 'material', takes: { socket: 'Geometry', kinds: ['material'] } },
    ...
    {
      word: 'Material.interlace', module: 'occlude', receiver: null,
      import: null, call: '{self}.interlace', returns: 'material',
      self: { param: 'material', takes: { socket: 'Geometry', kinds: ['material'] } },
      page: '/docs/reference/transforms', group: 'Transforms',
      params: [
        { name: 'opts', optional: false, options: [
    ...
    {
      word: 'Material.oscillate', module: 'occlude', receiver: null,
      import: null, call: '{self}.oscillate', returns: 'material',
      self: { param: 'material', takes: { socket: 'Geometry', kinds: ['material'] } },
      page: '/docs/reference/transforms', group: 'Transforms',
      params: [
        { name: 'opts', optional: false, options: [
    ...
    {
      word: 'Material.thicken', module: 'occlude', receiver: null,
      import: null, call: '{self}.thicken', returns: 'material',
      self: { param: 'material', takes: { socket: 'Geometry', kinds: ['material'] } },
      page: '/docs/reference/transforms', group: 'Transforms',
      params: [
        { name: 'opts', optional: false, options: [
    ...
    {
      word: 'Material.warp', module: 'occlude', receiver: null,
      import: null, call: '{self}.warp', returns: 'material',
      self: { param: 'material', takes: { socket: 'Geometry', kinds: ['material'] } },
      page: '/docs/reference/transforms', group: 'Transforms',
      params: [
        { name: 'opts', optional: false, options: [
    ...
    {
      word: 'curvature', module: 'occlude/3d', receiver: null,
      import: 'curvature', call: 'curvature', returns: 'VectorField',
      page: '/docs/reference/3d/fields', group: 'Surface fields',
      params: [
        { name: 'which', control: 'menu', choices: ['min', 'max'], optional: false },
        { name: 'options', optional: true, options: [
          { name: 'smoothing', takes: { socket: 'Number' }, optional: true },
          { name: 'creaseDegrees', takes: { socket: 'Number' }, optional: true },
          { name: 'minConfidence', takes: { socket: 'Number' }, optional: true },
        ] },
      ],
    },
    {
      word: 'light', module: 'occlude/3d', receiver: null,
      import: 'light', call: 'light', returns: 'Tone',
      page: '/docs/reference/3d/fields', group: 'Surface fields',
      params: [
        { name: 'options', optional: false, options: [
          { name: 'direction', takes: { socket: 'Vector' }, optional: false },
          { name: 'ambient', takes: { socket: 'Number' }, optional: true },
          { name: 'ramp', control: 'menu', choices: ['linear', 'smooth'], optional: true },
          { name: 'space', control: 'menu', choices: ['world', 'model'], optional: true },
          { name: 'floor', takes: { socket: 'Number' }, optional: true },
        ] },
      ],
    },
    {
      word: 'areaLoops', module: 'occlude', receiver: null,
      import: 'areaLoops', call: 'areaLoops', returns: 'shape',
      page: '', group: 'Other',
      params: [
        { name: 'input', takes: { socket: 'Geometry' }, optional: false },
    ...
    {
      word: 'FaceSelection.edges', module: 'occlude', receiver: null, value: true,
      import: null, call: '{self}.edges', returns: 'material',
      self: { param: 'faces', takes: { socket: 'Geometry', kinds: ['faces'] } },
      page: '', group: 'FaceSelection',
      params: [
    ...
    {
      word: 'FaceSelection.points', module: 'occlude', receiver: null, value: true,
      import: null, call: '{self}.points', returns: 'points',
      self: { param: 'faces', takes: { socket: 'Geometry', kinds: ['faces'] } },
      page: '', group: 'FaceSelection',
      params: [
    ...
    {
      word: 'Material.contours', module: 'occlude', receiver: null,
      import: null, call: '{self}.contours', returns: 'shape',
      self: { param: 'material', takes: { socket: 'Geometry', kinds: ['material'] } },
      page: '', group: 'Material',
      params: [
    ...
    {
      word: 'Material.faceAttribute', module: 'occlude', receiver: null,
      import: null, call: '{self}.faceAttribute', returns: 'material',
      self: { param: 'material', takes: { socket: 'Geometry', kinds: ['material'] } },
      page: '', group: 'Material',
      params: [
        { name: 'name', control: 'text', optional: false },
        { name: 'value', takes: { socket: 'Number' }, optional: false },
        { name: 'opts', optional: true, options: [
          { name: 'transfer', control: 'menu', choices: ['nearest', 'drop'], optional: true },
          { name: 'fallback', takes: { socket: 'Number' }, optional: true },
        ] },
      ],
    },
    {
      word: 'Material.faceAttributes', module: 'occlude', receiver: null,
      import: null, call: '{self}.faceAttributes', returns: 'material',
      self: { param: 'material', takes: { socket: 'Geometry', kinds: ['material'] } },
      page: '', group: 'Material',
      params: [
        { name: 'values', control: 'text', raw: true, optional: false },
    ...
    {
      word: 'Material.rowOfEdge', module: 'occlude', receiver: null,
      import: null, call: '{self}.rowOfEdge', returns: 'Number',
      self: { param: 'material', takes: { socket: 'Geometry', kinds: ['material'] } },
      page: '', group: 'Material',
      params: [
        { name: 'id', control: 'text', raw: true, optional: false },
      ],
    },
    {
      word: 'Material.rowOfPoint', module: 'occlude', receiver: null,
      import: null, call: '{self}.rowOfPoint', returns: 'Number',
      self: { param: 'material', takes: { socket: 'Geometry', kinds: ['material'] } },
      page: '', group: 'Material',
      params: [
        { name: 'id', control: 'text', raw: true, optional: false },
    ...
    {
      word: 'PointSelection.in', module: 'occlude', receiver: null,
      import: null, call: '{self}.in', returns: 'points',
      self: { param: 'points', takes: { socket: 'Geometry', kinds: ['points'] } },
      page: '', group: 'PointSelection',
      params: [
        { name: 'state', takes: { socket: 'Geometry', kinds: ['material'] }, optional: false },
      ],
    },
    {
    ...
    {
      word: 'PointSelection.points', module: 'occlude', receiver: null, value: true,
      import: null, call: '{self}.points', returns: 'points',
      self: { param: 'points', takes: { socket: 'Geometry', kinds: ['points'] } },
      page: '', group: 'PointSelection',
      params: [
    ...
    {
      word: 'PointSelection.thicken', module: 'occlude', receiver: null,
      import: null, call: '{self}.thicken', returns: 'material',
      self: { param: 'points', takes: { socket: 'Geometry', kinds: ['points'] } },
      page: '', group: 'PointSelection',
      params: [
    ...
    {
      word: 't.noiseField', module: 'occlude', receiver: 't',
      import: null, call: 't.noiseField', returns: 'VectorField',
      page: '', group: 'Other',
      params: [
        { name: 'amount', takes: { socket: 'Number' }, optional: false },
        { name: 'wavelength', takes: { socket: 'Number' }, optional: true },
      ],
    },
    {
  ...
  importable: [
    { module: 'occlude', names: [
      ...
      { name: 'areaLoops', spec: 'areaLoops' }, { name: 'assetTable', spec: 'assetTable' }, { name: 'banding', spec: 'banding' }, { name: 'bindToolkit', spec: 'bindToolkit' },
      ...
      { name: 'compileSketch', spec: 'compileSketch' }, { name: 'compileSketchAsync', spec: 'compileSketchAsync' }, { name: 'connect', spec: 'connect' }, { name: 'constructStrokes3', spec: 'constructStrokes3' },
      { name: 'cross', spec: 'cross' }, { name: 'curl', spec: 'curl' }, { name: 'curve', spec: 'curve' }, { name: 'curveMs', spec: 'curveMs' },
      { name: 'customFill', spec: 'customFill' }, { name: 'dash', spec: 'dash' }, { name: 'decimate', spec: 'decimate' }, { name: 'decodePlanBuffer', spec: 'decodePlanBuffer' },
      { name: 'decodeRender', spec: 'decodeRender' }, { name: 'DEFAULT_INPUTS', spec: 'DEFAULT_INPUTS' }, { name: 'DEFAULT_PAPERS', spec: 'DEFAULT_PAPERS' }, { name: 'DEFAULT_PENS', spec: 'DEFAULT_PENS' },
      { name: 'deform', spec: 'deform' }, { name: 'degrees', spec: 'degrees' }, { name: 'distance', spec: 'distance' }, { name: 'distanceTo', spec: 'distanceTo' },
      { name: 'DOC_PAGES', spec: 'DOC_PAGES' }, { name: 'docsPaper', spec: 'docsPaper' }, { name: 'dot', spec: 'dot' }, { name: 'dots', spec: 'dots' },
      ...
      { name: 'estimatePlanMs', spec: 'estimatePlanMs' }, { name: 'evalPrim', spec: 'evalPrim' }, { name: 'Execution', spec: 'Execution' }, { name: 'exportCollisions', spec: 'exportCollisions' },
      { name: 'exportGcode', spec: 'exportGcode' }, { name: 'exportPng', spec: 'exportPng' }, { name: 'exportSvg', spec: 'exportSvg' }, { name: 'extent', spec: 'extent' },
      { name: 'extrudeFaces3', spec: 'extrudeFaces3' }, { name: 'FaceMeasurements', spec: 'FaceMeasurements' }, { name: 'faces', spec: 'faces' }, { name: 'Faces', spec: 'Faces' },
      { name: 'FaceSelection', spec: 'FaceSelection' }, { name: 'FaceSelection3', spec: 'FaceSelection3' }, { name: 'FeatureKind3', spec: 'FeatureKind3' }, { name: 'FeatureSelection3', spec: 'FeatureSelection3' },
      { name: 'fill', spec: 'fill' }, { name: 'FILL_NAME_RE', spec: 'FILL_NAME_RE' }, { name: 'fillAsset', spec: 'fillAsset' }, { name: 'fillTable', spec: 'fillTable' },
      { name: 'fitDuration', spec: 'fitDuration' }, { name: 'force', spec: 'force' }, { name: 'formatSeed', spec: 'formatSeed' }, { name: 'fromAngle', spec: 'fromAngle' },
      { name: 'GpuSceneCompute3', spec: 'GpuSceneCompute3' }, { name: 'grad', spec: 'grad' }, { name: 'grid3', spec: 'grid3' }, { name: 'group', spec: 'group' },
      { name: 'h', spec: 'h' }, { name: 'hashPlan', spec: 'hashPlan' }, { name: 'hatch3', spec: 'hatch3' }, { name: 'inch', spec: 'inch' },
      { name: 'inheritEdge', spec: 'inheritEdge' }, { name: 'initOcclude', spec: 'initOcclude' }, { name: 'inspectHook', spec: 'inspectHook' }, { name: 'invert', spec: 'invert' },
      { name: 'invertRange', spec: 'invertRange' }, { name: 'isBuiltinFill', spec: 'isBuiltinFill' }, { name: 'isGeometry', spec: 'isGeometry' }, { name: 'isLineArt3', spec: 'isLineArt3' },
      { name: 'isSketch', spec: 'isSketch' }, { name: 'isSketchAsync', spec: 'isSketchAsync' }, { name: 'isStations', spec: 'isStations' }, { name: 'label', spec: 'label' },
      { name: 'labelWidth', spec: 'labelWidth' }, { name: 'Len', spec: 'Len' }, { name: 'length', spec: 'length' }, { name: 'liftAt', spec: 'liftAt' },
      { name: 'liftForTravel', spec: 'liftForTravel' }, { name: 'liftMapFromCounts', spec: 'liftMapFromCounts' }, { name: 'limit', spec: 'limit' }, { name: 'line', spec: 'line' },
      { name: 'lineArt3', spec: 'lineArt3' }, { name: 'liveExampleToJs', spec: 'liveExampleToJs' }, { name: 'loadFillModule', spec: 'loadFillModule' }, { name: 'long', spec: 'long' },
      { name: 'makePlan', spec: 'makePlan' }, { name: 'map', spec: 'map' }, { name: 'mask', spec: 'mask' }, { name: 'material', spec: 'material' },
      { name: 'Material', spec: 'Material' }, { name: 'meanBy', spec: 'meanBy' }, { name: 'measureFaces3', spec: 'measureFaces3' }, { name: 'mm', spec: 'mm' },
      { name: 'modify', spec: 'modify' }, { name: 'moduleName', spec: 'moduleName' }, { name: 'mul', spec: 'mul' }, { name: 'ngon', spec: 'ngon' },
      { name: 'norm', spec: 'norm' }, { name: 'numericLoops', spec: 'numericLoops' }, { name: 'openPlan', spec: 'openPlan' }, { name: 'ownedBy', spec: 'ownedBy' },
      { name: 'paper', spec: 'paper' }, { name: 'paperModel', spec: 'paperModel' }, { name: 'PAPERS', spec: 'PAPERS' }, { name: 'paperSize', spec: 'paperSize' },
      { name: 'parseCounts', spec: 'parseCounts' }, { name: 'parseLiveMeta', spec: 'parseLiveMeta' }, { name: 'parseSeed', spec: 'parseSeed' }, { name: 'parseToolpath', spec: 'parseToolpath' },
      { name: 'path', spec: 'path' }, { name: 'PathValue', spec: 'PathValue' }, { name: 'pen', spec: 'pen' }, { name: 'penModel', spec: 'penModel' },
      { name: 'pensToJson', spec: 'pensToJson' }, { name: 'perp', spec: 'perp' }, { name: 'plan', spec: 'plan' }, { name: 'PLAN_SCHEMA', spec: 'PLAN_SCHEMA' },
      { name: 'planarize', spec: 'planarize' }, { name: 'planAsBuffers', spec: 'planAsBuffers' }, { name: 'planBuffer', spec: 'planBuffer' }, { name: 'planDurationMs', spec: 'planDurationMs' },
      { name: 'planGcode', spec: 'planGcode' }, { name: 'planPolyline', spec: 'planPolyline' }, { name: 'planSchedule', spec: 'planSchedule' }, { name: 'planSettings', spec: 'planSettings' },
      { name: 'planSvg', spec: 'planSvg' }, { name: 'planToolpath', spec: 'planToolpath' }, { name: 'planValue', spec: 'planValue' }, { name: 'pointCloud3', spec: 'pointCloud3' },
      { name: 'PointSelection', spec: 'PointSelection' }, { name: 'PointSelection3', spec: 'PointSelection3' }, { name: 'polygon', spec: 'polygon' }, { name: 'primLength', spec: 'primLength' },
      { name: 'probeExpression', spec: 'probeExpression' }, { name: 'profileToJson', spec: 'profileToJson' }, { name: 'query', spec: 'query' }, { name: 'radians', spec: 'radians' },
      { name: 'range', spec: 'range' }, { name: 'rect', spec: 'rect' }, { name: 'refineLiftMap', spec: 'refineLiftMap' }, { name: 'render', spec: 'render' },
      { name: 'renderAsync', spec: 'renderAsync' }, { name: 'renderEncoded', spec: 'renderEncoded' }, { name: 'resolveDraw', spec: 'resolveDraw' }, { name: 'resolveFill', spec: 'resolveFill' },
      { name: 'rotate', spec: 'rotate' }, { name: 'roughen', spec: 'roughen' }, { name: 'rulings', spec: 'rulings' }, { name: 's', spec: 's' },
      { name: 'scale', spec: 'scale' }, { name: 'scanAssetNames', spec: 'scanAssetNames' }, { name: 'scanFillNames', spec: 'scanFillNames' }, { name: 'scanUiControls', spec: 'scanUiControls' },
      { name: 'schedulePlan', spec: 'schedulePlan' }, { name: 'sdf', spec: 'sdf' }, { name: 'section3', spec: 'section3' }, { name: 'segmentRuns', spec: 'segmentRuns' },
      { name: 'segmentsToBlocks', spec: 'segmentsToBlocks' }, { name: 'selectAll', spec: 'selectAll' }, { name: 'selectChains', spec: 'selectChains' }, { name: 'selectedFlat', spec: 'selectedFlat' },
      { name: 'selectProgress', spec: 'selectProgress' }, { name: 'selectTime', spec: 'selectTime' }, { name: 'SETTLE_FLOOR_MS', spec: 'SETTLE_FLOOR_MS' }, { name: 'settleAtLift', spec: 'settleAtLift' },
      { name: 'shader', spec: 'shader' }, { name: 'shaper', spec: 'shaper' }, { name: 'siteId', spec: 'siteId' }, { name: 'sketch', spec: 'sketch' },
      { name: 'sketchAsync', spec: 'sketchAsync' }, { name: 'smooth', spec: 'smooth' }, { name: 'snapshotSurface3', spec: 'snapshotSurface3' }, { name: 'standaloneEstimate', spec: 'standaloneEstimate' },
      ...
      { name: 'tagDraws', spec: 'tagDraws' }, { name: 'times', spec: 'times' }, { name: 'tourBudget', spec: 'tourBudget' }, { name: 'tracePrim', spec: 'tracePrim' },
      { name: 'transformSurface3', spec: 'transformSurface3' }, { name: 'translate', spec: 'translate' }, { name: 'travelLiftPulse', spec: 'travelLiftPulse' }, { name: 'ui', spec: 'ui' },
      { name: 'unit', spec: 'unit' }, { name: 'userModules', spec: 'userModules' }, { name: 'userUnitsToPaper', spec: 'userUnitsToPaper' }, { name: 'vectorField', spec: 'vectorField' },
      { name: 'voronoi', spec: 'voronoi' }, { name: 'w', spec: 'w' }, { name: 'within', spec: 'within' }, { name: 'wobble', spec: 'wobble' },
    ] },
  ...
  importableTypes: [
    { module: 'occlude', names: [
      'AreaInput', 'AssetPixels', 'AssetTable', 'AsyncSketchDef', 'Attributes3', 'Bounds',
      'Camera3', 'CellGeometry', 'ChildInterval', 'ChildSpec', 'ClassifiedFeature3', 'ClassifiedScene3',
      'ClipValue', 'CompileConfig', 'Contour', 'Corner', 'Crossing', 'Curve',
      'CustomFillFn', 'CustomPrimitive', 'DeformOptions3', 'DistanceField', 'DrawEntry', 'DrawHook',
      'DrawRequest', 'DrawSite', 'DrawTiming', 'Drawing3', 'DrawingPlan', 'Edge',
      'EdgeMeasure3', 'EdgeQuery', 'EdgeRef', 'EdgeTransfer', 'EncodedScene', 'EstimateOpts',
      'EventCandidate', 'ExecutionInputs', 'ExportOptions', 'Face', 'FaceMeasure', 'Feature3',
      'FieldAlign', 'FieldFn', 'FillAnchor', 'FillAssetDef', 'FillCtx', 'FillRegion',
      'FillSpec', 'FillTable', 'FirstHit', 'FitResult', 'FlatChain', 'Fragment',
      'GcodeJob', 'Geometry', 'GroupOpts', 'GroupValue', 'Handle', 'HatchFamily3',
