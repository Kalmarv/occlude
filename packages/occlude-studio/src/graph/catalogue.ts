...
export const CATALOGUE: Catalogue = {
  ...
  importable: [
    { module: 'occlude', names: [
      ...
      { name: 'modify', spec: 'modify' }, { name: 'moduleName', spec: 'moduleName' }, { name: 'mul', spec: 'mul' }, { name: 'neighbours', spec: 'neighbours' },
      { name: 'ngon', spec: 'ngon' }, { name: 'norm', spec: 'norm' }, { name: 'numericLoops', spec: 'numericLoops' }, { name: 'openPlan', spec: 'openPlan' },
      { name: 'ownedBy', spec: 'ownedBy' }, { name: 'paper', spec: 'paper' }, { name: 'paperModel', spec: 'paperModel' }, { name: 'PAPERS', spec: 'PAPERS' },
      { name: 'paperSize', spec: 'paperSize' }, { name: 'parseCounts', spec: 'parseCounts' }, { name: 'parseLiveMeta', spec: 'parseLiveMeta' }, { name: 'parseSeed', spec: 'parseSeed' },
      { name: 'parseToolpath', spec: 'parseToolpath' }, { name: 'path', spec: 'path' }, { name: 'PathValue', spec: 'PathValue' }, { name: 'pen', spec: 'pen' },
      { name: 'penModel', spec: 'penModel' }, { name: 'pensToJson', spec: 'pensToJson' }, { name: 'perp', spec: 'perp' }, { name: 'plan', spec: 'plan' },
      { name: 'PLAN_SCHEMA', spec: 'PLAN_SCHEMA' }, { name: 'planarize', spec: 'planarize' }, { name: 'planAsBuffers', spec: 'planAsBuffers' }, { name: 'planBuffer', spec: 'planBuffer' },
      { name: 'planDurationMs', spec: 'planDurationMs' }, { name: 'planGcode', spec: 'planGcode' }, { name: 'planPolyline', spec: 'planPolyline' }, { name: 'planSchedule', spec: 'planSchedule' },
      { name: 'planSettings', spec: 'planSettings' }, { name: 'planSvg', spec: 'planSvg' }, { name: 'planToolpath', spec: 'planToolpath' }, { name: 'planValue', spec: 'planValue' },
      { name: 'pointCloud3', spec: 'pointCloud3' }, { name: 'PointSelection', spec: 'PointSelection' }, { name: 'PointSelection3', spec: 'PointSelection3' }, { name: 'polygon', spec: 'polygon' },
      { name: 'primLength', spec: 'primLength' }, { name: 'probeExpression', spec: 'probeExpression' }, { name: 'profileToJson', spec: 'profileToJson' }, { name: 'query', spec: 'query' },
      { name: 'radians', spec: 'radians' }, { name: 'range', spec: 'range' }, { name: 'rect', spec: 'rect' }, { name: 'refineLiftMap', spec: 'refineLiftMap' },
      { name: 'render', spec: 'render' }, { name: 'renderAsync', spec: 'renderAsync' }, { name: 'renderEncoded', spec: 'renderEncoded' }, { name: 'resolveDraw', spec: 'resolveDraw' },
      { name: 'resolveFill', spec: 'resolveFill' }, { name: 'rotate', spec: 'rotate' }, { name: 'roughen', spec: 'roughen' }, { name: 'rulings', spec: 'rulings' },
      { name: 's', spec: 's' }, { name: 'scale', spec: 'scale' }, { name: 'scanAssetNames', spec: 'scanAssetNames' }, { name: 'scanFillNames', spec: 'scanFillNames' },
      { name: 'scanUiControls', spec: 'scanUiControls' }, { name: 'schedulePlan', spec: 'schedulePlan' }, { name: 'sdf', spec: 'sdf' }, { name: 'section3', spec: 'section3' },
      { name: 'segmentRuns', spec: 'segmentRuns' }, { name: 'segmentsToBlocks', spec: 'segmentsToBlocks' }, { name: 'selectAll', spec: 'selectAll' }, { name: 'selectChains', spec: 'selectChains' },
      { name: 'selectedFlat', spec: 'selectedFlat' }, { name: 'selectProgress', spec: 'selectProgress' }, { name: 'selectTime', spec: 'selectTime' }, { name: 'SETTLE_FLOOR_MS', spec: 'SETTLE_FLOOR_MS' },
      { name: 'settleAtLift', spec: 'settleAtLift' }, { name: 'shader', spec: 'shader' }, { name: 'shaper', spec: 'shaper' }, { name: 'siteId', spec: 'siteId' },
      { name: 'sketch', spec: 'sketch' }, { name: 'sketchAsync', spec: 'sketchAsync' }, { name: 'smooth', spec: 'smooth' }, { name: 'snapshotSurface3', spec: 'snapshotSurface3' },
      { name: 'standaloneEstimate', spec: 'standaloneEstimate' }, { name: 'stationsMaterial', spec: 'stationsMaterial' }, { name: 'stepsSurface3', spec: 'stepsSurface3' }, { name: 'stroke', spec: 'stroke' },
      { name: 'strokes', spec: 'strokes' }, { name: 'sub', spec: 'sub' }, { name: 'subPrim', spec: 'subPrim' }, { name: 'sum', spec: 'sum' },
      { name: 'sumBy', spec: 'sumBy' }, { name: 'sumForces', spec: 'sumForces' }, { name: 'surface3', spec: 'surface3' }, { name: 'svg', spec: 'svg' },
      { name: 'synth', spec: 'synth' }, { name: 'tagDraws', spec: 'tagDraws' }, { name: 'times', spec: 'times' }, { name: 'tourBudget', spec: 'tourBudget' },
      ...
      { name: 'vectorField', spec: 'vectorField' }, { name: 'voronoi', spec: 'voronoi' }, { name: 'w', spec: 'w' }, { name: 'within', spec: 'within' },
      { name: 'wobble', spec: 'wobble' },
    ] },
  ...
  importableTypes: [
    { module: 'occlude', names: [
      ...
      'Fragment', 'GcodeJob', 'Geometry', 'GroupOpts', 'GroupValue', 'Handle',
      'HatchFamily3', 'HatchSource3', 'ImageChannel', 'ImagePlacement', 'ImageSampler', 'InspectionEntry',
      'InspectionPayload', 'InterlaceOpts', 'InvertValue', 'IsoContour', 'IsoOpts', 'L',
      'LabelOpts', 'LiftMap', 'LiftModel', 'LineArtOptions3', 'LineArtScene3', 'LineSet3',
      'LiveMeta', 'MachineProfileTS', 'MeasureOpts', 'ModelingProgress3', 'ModelingStats3', 'ModifierValue',
      'MotionBlock', 'MotionLimits', 'NearestHit', 'NearestQuery3', 'NeighbourStats', 'Next',
      'OscillateAmount', 'OscillateOpts', 'Paper', 'PaperChoice', 'PaperDef', 'PaperFrame3',
      'PaperSpec', 'ParsedSeed', 'PenDef', 'PenTiming', 'PlanChain', 'PlanEstimate',
      'PlanOptions', 'PlanSchedule', 'PlanSelection', 'PlanSettings', 'PlanarEvent', 'PlanarizeOpts',
      'PlannedSegment', 'Point', 'PointEdit3', 'PointMeasure3', 'PointsLike', 'PolygonOpts',
      'Prepared', 'Prim', 'ProbeSummary', 'ProgressListener3', 'QuadtreeOpts', 'RandomStream',
      'RawRender', 'RayQuery3', 'Ref', 'RelaxOpts', 'RenderOptions', 'RenderResult',
      'ReplaceOpts', 'ResolvedDraw', 'RidgeContour', 'RidgeOpts', 'RulingOpts', 'ScatterOpts',
      'SceneCompute3', 'SectionPlane3', 'SegmentRun', 'SettleOpts', 'SettleParent', 'SettlePoint',
      'ShaderValue', 'ShapeOpts', 'ShapeValue', 'Shaper', 'ShaperOpts', 'ShaperPoint',
      'Sites', 'SketchConfig', 'SketchDef', 'SketchOptions', 'SnapField', 'SnapOpts',
      'Snapshot', 'Sources', 'SplitOpts', 'StageEvent3', 'StageListener3', 'Station',
      'StepRule', 'StepsOptions', 'StreamOpts', 'Stroke3', 'StrokeCtx', 'StrokeInk',
      'StrokeProgram', 'StrokeReference3', 'Surface3', 'SurfaceCorner3', 'SurfaceCurvePoint3', 'SurfaceCurveSegment3',
      'SurfaceCurves3', 'SurfaceHit3', 'SurfaceObject3', 'SurfaceQueryInput3', 'SurfaceQueryResult3', 'SynthBounds',
      'SynthFn', 'SynthOpts', 'SynthStats', 'ThickenOpts', 'ThrowOpts', 'TimeSelection',
      'Toolkit', 'TrailsOpts', 'Transfer', 'TransferPolicy', 'TransformOp', 'Tree',
      'UiControl', 'UiOpts', 'Vec', 'Vec3', 'VectorFieldFn', 'Vertex',
      'VoronoiLinks', 'WarpFn', 'WarpOpts', 'WasmModule', 'Winding', 'WireObject3',
      'WithinFaces', 'XY', 'YAxis',
    ] },
    { module: 'occlude/3d', names: [
