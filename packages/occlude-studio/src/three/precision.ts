...
export async function precision3(){
  ...
  try {
    ...
    return {passed:true,adapter:{vendor:gpu.adapterInfo.vendor,architecture:gpu.adapterInfo.architecture,isFallbackAdapter:gpu.adapterInfo.isFallbackAdapter},paperBudgetMm:.005,pairCapacity:1,cases};
