...
```sh
/tmp/occlude-blender-reference/blender-5.2.1-linux-x64/blender --background --factory-startup --python-exit-code 1 --python packages/occlude/test/fixtures/three-reference/blender-lineart.py -- development/3d/reference/fixtures.json development/3d/reference/blender.json
...
pnpm --filter occlude exec tsx tools/compare-blender3.ts test/fixtures/three-reference test/fixtures/three-reference/gpu.json
```
