/**
 * Hershey Script Simplex — Script simplex: a joined hand, one stroke wide.
 *
 * The bytes below are scripts.jhf from the Usenet Hershey font distribution,
 ...
 * (hershey-fonts/scripts.jhf), whose COPYING keeps the .jhf data under this
...
/** scripts.jhf, as distributed: one glyph per line, ASCII order from space. */
export const SCRIPTS_JHF = `  699  1JZ
...
/** Script simplex: a joined hand, one stroke wide. */
export const hersheyScript: Font = lazyFont('Hershey Script Simplex', () => SCRIPTS_JHF);
