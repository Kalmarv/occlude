/**
 * Hershey Roman Triplex — Roman triplex: a serif face drawn with three strokes to a stem.
 *
 * The bytes below are rowmant.jhf from the Usenet Hershey font distribution,
 ...
 * (hershey-fonts/rowmant.jhf), whose COPYING keeps the .jhf data under this
...
/** rowmant.jhf, as distributed: one glyph per line, ASCII order from space. */
export const ROWMANT_JHF = ` 3199  1JZ
...
/** Roman triplex: a serif face drawn with three strokes to a stem. */
export const hersheyTriplex: Font = lazyFont('Hershey Roman Triplex', () => ROWMANT_JHF);
