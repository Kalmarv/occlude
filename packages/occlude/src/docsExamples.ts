...
export const DOC_PAGES: { slug: string; title: string; file: string; live: boolean; group: 'topics' | 'workshop' | 'developer' }[] = [
  ...
  { slug: 'examples-wheel', title: 'Example: wheel', file: 'examples/wheel.mdx', live: true, group: 'topics' },
  { slug: 'examples-asemic', title: 'Example: asemic', file: 'examples/asemic.mdx', live: true, group: 'topics' },
