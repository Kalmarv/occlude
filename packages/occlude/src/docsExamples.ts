...
export const DOC_PAGES: { slug: string; title: string; file: string; live: boolean; group: 'topics' | 'workshop' | 'developer' }[] = [
  ...
  { slug: 'reference-faces', title: 'Reference: Faces', file: 'reference/faces.md', live: true, group: 'topics' },
  { slug: 'examples-tangle', title: 'Example: Tangle', file: 'examples/tangle.md', live: true, group: 'topics' },
