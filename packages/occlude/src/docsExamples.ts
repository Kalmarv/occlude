...
export const DOC_PAGES: { slug: string; title: string; file: string; live: boolean; group: 'topics' | 'workshop' | 'developer' }[] = [
  ...
  { slug: 'examples-sounding', title: 'Example: sounding', file: 'examples/sounding.mdx', live: true, group: 'topics' },
  { slug: 'examples-cone', title: 'Example: cone', file: 'examples/cone.mdx', live: true, group: 'topics' },
  { slug: 'examples-cantilever', title: 'Example: cantilever', file: 'examples/cantilever.mdx', live: true, group: 'topics' },
  { slug: 'examples-lichen', title: 'Example: lichen', file: 'examples/lichen.mdx', live: true, group: 'topics' },
  { slug: 'examples-interval', title: 'Example: interval', file: 'examples/interval.mdx', live: true, group: 'topics' },
  { slug: 'examples-squall', title: 'Example: squall', file: 'examples/squall.mdx', live: true, group: 'topics' },
  { slug: 'examples-train', title: 'Example: train', file: 'examples/train.mdx', live: true, group: 'topics' },
  { slug: 'examples-fivefold', title: 'Example: fivefold', file: 'examples/fivefold.mdx', live: true, group: 'topics' },
  { slug: 'examples-attempts', title: 'Example: attempts', file: 'examples/attempts.mdx', live: true, group: 'topics' },
  { slug: 'examples-leaf', title: 'Example: leaf', file: 'examples/leaf.mdx', live: true, group: 'topics' },
  { slug: 'examples-corridor', title: 'Example: corridor', file: 'examples/corridor.mdx', live: true, group: 'topics' },
  { slug: 'examples-addresses', title: 'Example: addresses', file: 'examples/addresses.mdx', live: true, group: 'topics' },
  { slug: 'examples-calls', title: 'Example: calls', file: 'examples/calls.mdx', live: true, group: 'topics' },
  { slug: 'examples-hyperbolic-plane-and-disk', title: 'Example: hyperbolic-plane-and-disk', file: 'examples/hyperbolic-plane-and-disk.mdx', live: true, group: 'topics' },
  { slug: 'examples-hyperbolic-chords-and-geodesics', title: 'Example: hyperbolic-chords-and-geodesics', file: 'examples/hyperbolic-chords-and-geodesics.mdx', live: true, group: 'topics' },
  { slug: 'examples-hyperbolic-circles', title: 'Example: hyperbolic-circles', file: 'examples/hyperbolic-circles.mdx', live: true, group: 'topics' },
