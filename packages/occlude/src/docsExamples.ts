...
export const DOC_PAGES: { slug: string; title: string; file: string; live: boolean; group: 'topics' | 'workshop' | 'developer' }[] = [
  ...
  { slug: 'reference-3d-meshes', title: 'Reference: 3D meshes', file: 'reference/3d/meshes.mdx', live: true, group: 'topics' },
  ...
  { slug: 'examples-veil', title: 'Example: veil', file: 'examples/veil.mdx', live: true, group: 'topics' },
  ...
  { slug: 'examples-ball', title: 'Example: ball', file: 'examples/ball.mdx', live: true, group: 'topics' },
  { slug: 'examples-respond', title: 'Example: respond', file: 'examples/respond.mdx', live: true, group: 'topics' },
  { slug: 'examples-cellular-lace', title: 'Example: cellular-lace', file: 'examples/cellular-lace.mdx', live: true, group: 'topics' },
  ...
  { slug: 'examples-tonal-hatch', title: 'Example: tonal-hatch', file: 'examples/tonal-hatch.mdx', live: true, group: 'topics' },
  { slug: 'examples-cubic-disarray', title: 'Example: cubic-disarray', file: 'examples/cubic-disarray.mdx', live: true, group: 'topics' },
  { slug: 'examples-piled-squares', title: 'Example: piled-squares', file: 'examples/piled-squares.mdx', live: true, group: 'topics' },
  { slug: 'examples-un-deux-trois', title: 'Example: un-deux-trois', file: 'examples/un-deux-trois.mdx', live: true, group: 'topics' },
  { slug: 'examples-circle-packing', title: 'Example: circle-packing', file: 'examples/circle-packing.mdx', live: true, group: 'topics' },
  { slug: 'examples-hypnotic-squares', title: 'Example: hypnotic-squares', file: 'examples/hypnotic-squares.mdx', live: true, group: 'topics' },
  { slug: 'examples-mondrian', title: 'Example: mondrian', file: 'examples/mondrian.mdx', live: true, group: 'topics' },
