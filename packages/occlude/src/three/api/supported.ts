...
export class SurfaceCurves<A extends Attributes3={}> {
 ...
 constructor(readonly network:SurfaceCurveNetwork3,options:SurfaceCurveOptions={}){
  ...
  this.edges=new Collection(network,'edge',edges as readonly SurfaceCurveEdge<A>[],indices=>new SurfaceCurves<A>(selectSurfaceCurveNetwork3(network,indices),this));
  Object.freeze(this);
 }
