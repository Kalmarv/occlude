...
// Blume config source SHA-256: 5ade3e8df8c1866362f7dbb1e62032cec424e3e0d5900547155e7299971984e7
...
const loadBlumeConfig = createModuleLoader();
const blumeConfig = await loadBlumeConfig(resolve(dirname(fileURLToPath(import.meta.url)), "../blume.config.ts"));

export default defineConfig({
  root: "/home/kalmarv/containers/occlude/packages/occlude-docs/.blume",
  srcDir: "/home/kalmarv/containers/occlude/packages/occlude-docs/.blume/src",
  outDir: "/home/kalmarv/containers/occlude/packages/occlude-docs/dist",
  publicDir: "/home/kalmarv/containers/occlude/packages/occlude-docs/public",
  cacheDir: "/home/kalmarv/containers/occlude/packages/occlude-docs/.blume/.cache/astro",
  output: "static",
  base: "/docs",
  ...
  integrations: [mdx({ processor: blumeMdxProcessor({"basePath":"","codeThemes":{"dark":"github-dark","light":"github-light"},"contentRoot":"/home/kalmarv/containers/occlude/docs","deployBase":"/docs","headingAnchors":true}) }), blumeIntegration({"pages":[]}), ...(blumeConfig?.integrations ?? [])],
  markdown: {
    processor: blumeMarkdownProcessor({"basePath":"","codeThemes":{"dark":"github-dark","light":"github-light"},"contentRoot":"/home/kalmarv/containers/occlude/docs","deployBase":"/docs","headingAnchors":true}),
    shikiConfig: {
      themes: {
        light: "github-light",
        dark: "github-dark",
  ...
  vite: {
    cacheDir: "/home/kalmarv/containers/occlude/packages/occlude-docs/.blume/.cache/vite",
    plugins: [runtimeModulesPlugin(), tailwindcss(), includeHmrPlugin("/home/kalmarv/containers/occlude/packages/occlude-docs/.blume/src/generated/includes.json"), prerenderDepsPlugin()],
    ...
    optimizeDeps: {
      entries: ["/home/kalmarv/containers/occlude/packages/occlude-docs/islands/**/*.{jsx,svelte,tsx,vue}"],
      include: [],
    },
    ...
    resolve: {
      alias: {
        "blume:ask": "/home/kalmarv/containers/occlude/packages/occlude-docs/.blume/src/generated/Ask.astro",
        "blume:examples": "/home/kalmarv/containers/occlude/packages/occlude-docs/.blume/src/generated/examples.ts",
        "blume:examples-theme": "/home/kalmarv/containers/occlude/packages/occlude-docs/.blume/src/generated/examples.css",
        "blume:features": "/home/kalmarv/containers/occlude/packages/occlude-docs/.blume/src/generated/features.ts",
        "blume:search-client": "/home/kalmarv/containers/occlude/packages/occlude-docs/.blume/src/generated/search-client.ts",
        "blume:theme": "/home/kalmarv/containers/occlude/packages/occlude-docs/.blume/src/generated/app.css",
      },
    },
    server: {
      fs: {
        allow: ["/home/kalmarv/containers/occlude","/home/kalmarv/containers/occlude/packages/occlude-docs"],
      },
    },
  },
});
