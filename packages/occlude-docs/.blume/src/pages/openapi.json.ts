...
const payload = {
    ...
    "schemas": {
      "JsonRpcRequest": {
        ...
        "properties": {
          ...
          "method": {
            "description": "The MCP method, e.g. `initialize` or `tools/call`.",
            "type": "string"
          },
          "params": {
      ...
      "NavLink": {
        "properties": {
          "href": {
            "description": "Link target — an internal route or an external URL.",
            "type": "string"
          },
          "icon": {
        ...
        "oneOf": [
          {
            "properties": {
              ...
              "pageId": {
                "description": "The page's stable content id.",
                "type": "string"
              },
              "route": {
                "description": "The page's route.",
                "type": "string"
              }
            },
            "required": [
          ...
          },
          {
            "properties": {
              ...
              "path": {
                "description": "The group's route prefix (not necessarily a page).",
                "type": "string"
              },
              "route": {
                "description": "The group's index page route, when it has one.",
                "type": "string"
              }
            },
            "required": [
      ...
      "NavTab": {
        "properties": {
          "href": {
            "description": "The clickable target when it differs from `path` (the section's first page).",
            "type": "string"
          },
          "icon": {
            "type": "string"
          ...
          "path": {
            "description": "The tab's section prefix.",
            "type": "string"
          }
        },
        "required": [
      ...
      "Navigation": {
        ...
        "properties": {
          ...
          "root": {
            "description": "The tree root's route (`/`, or a locale/version prefix).",
            "type": "string"
          },
          "selectors": {
            "items": {
      ...
      "Page": {
        "allOf": [
          ...
          },
          {
            "properties": {
              "markdown": {
                "description": "The page as agent Markdown: frontmatter included, components downleveled to plain Markdown.",
                "type": "string"
              }
            },
            "required": [
      ...
      "PageSummary": {
        "properties": {
          "contentType": {
            "description": "The page's content type (frontmatter `type`).",
            "type": "string"
          },
          "description": {
            "type": "string"
          ...
          "locale": {
            "description": "The page's locale code.",
            "type": "string"
          },
          "markdownUrl": {
          ...
          "route": {
            "description": "The page's route (`/guides/install`); the key every other operation takes.",
            "type": "string"
          },
          "title": {
            "type": "string"
      ...
      "PagesIndex": {
        "properties": {
          ...
          "generator": {
            "description": "The Blume version that built the site.",
            "type": "string"
          },
          "pages": {
            "items": {
      ...
      "Problem": {
        ...
        "properties": {
          "code": {
            "description": "Stable error code (e.g. `PAGE_NOT_FOUND`).",
            "type": "string"
          },
          "detail": {
          ...
          "instance": {
            "description": "The request path the problem occurred on.",
            "type": "string"
          },
          "links": {
          ...
          "type": {
            "description": "Problem type URI; `about:blank` by default.",
            "type": "string"
          }
        },
        "required": [
      ...
      "SearchHit": {
        "properties": {
          ...
          "excerpt": {
            "description": "The page description, else the start of its content.",
            "type": "string"
          },
          "facets": {
            "additionalProperties": {
          ...
          "route": {
            "description": "The page's route; pass it to `getPage`.",
            "type": "string"
          },
          "title": {
            "type": "string"
      ...
      "get": {
        ...
        "responses": {
          ...
          "default": {
            ...
            "description": "An error, as problem details."
          }
        },
      ...
      "get": {
        ...
        "responses": {
          ...
          "404": {
            ...
            "description": "No page has that route."
          },
          "default": {
            "content": {
              "application/problem+json": {
      ...
      "get": {
        ...
        "responses": {
          ...
          "404": {
            ...
            "description": "No page has that route; the body lists where to look next."
          }
        },
      ...
      "get": {
        ...
        "responses": {
          "200": {
            ...
            "description": "Every page's Markdown."
          }
        },
  ...
  "tags": [
    {
      "description": "Enumerate and read documentation pages.",
      "name": "Pages"
    },
    {
      "description": "How the docs are organized.",
      "name": "Navigation"
    },
    {
      "description": "Plain-text and Markdown surfaces.",
      "name": "Markdown"
    },
    {
